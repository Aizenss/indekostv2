    ...
    <div class="sm:ml-64">
        ...
        <section class="tentang my-10">
            <div class="text-center">
                ...
                <span class="font-medium text-xl text-gray-900 mt-3">Indekost adalah platform pencarian kost terkemuka yang
            ...
            <div class="benefit text-center mt-5">
                ...
                <div class="grid grid-cols-3 gap-5 mt-8 ">
                    <div class="mempermudah ">
                        ...
                        <span class="font-semibold text-gray-900 text-lg">Mempercepat dan mempermudah anda dalam mencari
                            kost</span>
                    </div>
                    <div class="aman">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                        ...
                        <span class="font-semibold text-gray-900 text-lg">Dijamin tempat yang sudah terdaftar aman dan
                            nyaman</span>
                    </div>
                    <div class="aman">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                        ...
                        <span class="font-semibold text-gray-900 text-lg">Pembayaran dijamin aman karena telah di kelola
