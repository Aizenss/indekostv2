...
@section('isi')
    <div class="p-4 sm:ml-64">
        ...
        <section class="tentang my-10">
            ...
            <div class="benefit mt-5">
                <h5 class="mb-2 text-3xl font-bold text-gray-900">Keuntungan ketika mencari lewat <span class="text-lime-700">IN DE KOST</span></h5>
                <div class="grid grid-cols-3 gap-5">
                    <div class="mempermudah ">
                        ...
                        <span class="font-semibold text-gray-900 text-lg">Mempercepat dan mempermudah anda dalam mencari kost</span>                          
                    </div>
                    <div class="aman ">
                        ...
                        <span class="font-semibold text-gray-900 text-lg">Dijamin tempat sudah terdaftar aman dan nyaman</span>                          
                    </div>
                </div>
            </div>
        </section>
