                            ...
                            <a href="https://discord.gg/4eeurUVvTy" class="hover:underline flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22.45" height="32"
                                    ...
                                    <g fill="none">
                                        ...
                                        <defs>
                                            <radialGradient id="skillIconsInstagram0" cx="0" cy="0"
                                                r="1" gradientTransform="matrix(0 -253.715 235.975 0 68 275.717)"
                                            ...
                                            <radialGradient id="skillIconsInstagram1" cx="0" cy="0"
                                                r="1"
