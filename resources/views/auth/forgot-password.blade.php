...
@section('isi')
  <div class="relative flex justify-center items-center h-screen">
    ...
    <a href="#"
      class="relative block max-w-xl max-h-100 p-6 bg-[#739072] border border-gray-200 rounded-lg shadow text-center">
      <form method="POST" action="{{ route('password.email') }}">
        ...
        <div class="justify-center">
          ...
          <p class="text-white mb-6 text-sm mr-10 ml-10">Lupa kata sandi Anda? Tidak masalah. Cukup beri tahu kami alamat
            email Anda dan kami akan mengirimkan tautan pengaturan ulang kata sandi melalui email yang memungkinkan Anda
