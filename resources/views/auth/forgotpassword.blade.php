    ...
    <div class="coba flex-1 flex items-center justify-center">
        <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-md sm:p-6 md:p-8">
            <form class="space-y-1" action="#">
                <h5 class="text-2xl font-extrabold text-gray-900 text-center mb-4">Reset Password</h5>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    <label for="confirm_password" class="block text-sm font-medium text-gray-900 mb-2">Konfirmasi Password</label>
                ...
                <br>
                <button type="submit" class="w-full text-dark bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center shadow-md transition-colors duration-300 ease-in-out">Ubah</button>
            </form>
        </div>
    </div>
</div>
