        ...
        <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-md sm:p-6 md:p-8 dark:bg-dark dark:border-gray-700">
            <form class="space-y-6" action="#">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input type="email" name="email" id="email" class="shadow-md bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pl-10" placeholder="name@company.com" required>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input type="password" name="password" id="password" placeholder="••••••••" class="shadow-md bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pl-10" required>
                        <div class="absolute inset-y-0 left-0 flex items-center pl-2">
