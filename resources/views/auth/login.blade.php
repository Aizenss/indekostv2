        ...
        <div class="w-full max-w-sm p-4 border border-gray-200 rounded-lg shadow-2xl sm:p-6 md:p-8 ">
            <form class="space-y-3" action="{{route('login')}}" method="POST">
                ...
                <div class="mb-2">
                    ...
                    <div class="relative">
                        <input type="email" name="email" id="email" class="shadow-md bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Contoh@gmail.com">
                    </div>
                </div>
                <div class="mb-2">
