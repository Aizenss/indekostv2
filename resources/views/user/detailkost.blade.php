  ...
  <div class="py-10 px-[140px]">
    ...
    <section class="informan my-5">
          ...
          <div class="max-w-sm bg-gray-200 border border-gray-200 rounded-lg shadow ">
            ...
            <div class="p-5">
              <div class="flex justify-between items-center">
                ...
                <h5 class=" text-base font-semibold tracking-tight text-gray-900"><i class="fa-solid fa-users me-1"></i>2
                  Orang</h5>
              </div>
      ...
      <div class="flex items-center gap-4">
        <span class="font-bold text-[80px] ">{{ $averageRating }} <i class="fas fa-star text-yellow-300"></i></span>
