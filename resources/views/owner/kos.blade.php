                                ...
                                <tr class="bg-white dark:bg-gray-800 items-center">
                                    ...
                                    <td class="px-4 py-4 text-xs flex items-center gap-1">
                                        ...
                                        @else
                                            ...
                                            <form id="deleteForm" action="{{ route('owner.kos.hapus', ['id' => $kost->id]) }}" method="post" class="my-auto focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-1 me-2 mb-2">
                                                @method('delete')
                                                @csrf

                                                <button type="button" onclick="konfirmasiHapus()" class="text-white self-center">
                                            ...
                                            <script>
                                                function konfirmasiHapus() {
                                                    // Menggunakan pustaka SweetAlert2
                                                    Swal.fire({
