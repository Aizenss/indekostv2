                            ...
                            <tr class="bg-white dark:bg-gray-800 items-center">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('owner.kamar.tambah', $kost->id) }}"
                                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 "><span
                                            class="text-lg mr-4 font-black">+</span>Kamar</a>
                                </td>
                            </tr>
                        @empty
                            <tr class="bg-white dark:bg-gray-800 items-center">
