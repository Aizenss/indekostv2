...
<div class=" ml-6 bg-gray-200 p-4 text-center w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="flex flex-col items-center pb-10">
        ...
        <div class="flex mt-4 md:mt-6">
            <a href="{{ route('kelolaowner.delete', ['owner' => $owner->id]) }}"  class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white  bg-[#4F6F52] rounded-lg hover:bg[#000] focus:ring-4 focus:outline-none focus:ring-blue-300 ">Hapus</a>
